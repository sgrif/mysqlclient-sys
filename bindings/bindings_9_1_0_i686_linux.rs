...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MYSQL_DATA"][::std::mem::size_of::<MYSQL_DATA>() - 20usize];
    ["Alignment of MYSQL_DATA"][::std::mem::align_of::<MYSQL_DATA>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MYSQL"][::std::mem::size_of::<MYSQL>() - 900usize];
    ["Alignment of MYSQL"][::std::mem::align_of::<MYSQL>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of MYSQL_RES"][::std::mem::align_of::<MYSQL_RES>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MYSQL_RPL"][::std::mem::size_of::<MYSQL_RPL>() - 44usize];
    ["Alignment of MYSQL_RPL"][::std::mem::align_of::<MYSQL_RPL>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MYSQL_STMT"][::std::mem::size_of::<MYSQL_STMT>() - 636usize];
    ["Alignment of MYSQL_STMT"][::std::mem::align_of::<MYSQL_STMT>() - 4usize];
    ...
    ["Offset of field: MYSQL_STMT::data_cursor"]
        [::std::mem::offset_of!(MYSQL_STMT, data_cursor) - 52usize];
    ["Offset of field: MYSQL_STMT::read_row_func"]
        [::std::mem::offset_of!(MYSQL_STMT, read_row_func) - 56usize];
    ["Offset of field: MYSQL_STMT::affected_rows"]
        [::std::mem::offset_of!(MYSQL_STMT, affected_rows) - 60usize];
    ["Offset of field: MYSQL_STMT::insert_id"]
        [::std::mem::offset_of!(MYSQL_STMT, insert_id) - 68usize];
    ["Offset of field: MYSQL_STMT::stmt_id"][::std::mem::offset_of!(MYSQL_STMT, stmt_id) - 76usize];
    ["Offset of field: MYSQL_STMT::flags"][::std::mem::offset_of!(MYSQL_STMT, flags) - 80usize];
    ["Offset of field: MYSQL_STMT::prefetch_rows"]
        [::std::mem::offset_of!(MYSQL_STMT, prefetch_rows) - 84usize];
    ["Offset of field: MYSQL_STMT::server_status"]
        [::std::mem::offset_of!(MYSQL_STMT, server_status) - 88usize];
    ["Offset of field: MYSQL_STMT::last_errno"]
        [::std::mem::offset_of!(MYSQL_STMT, last_errno) - 92usize];
    ["Offset of field: MYSQL_STMT::param_count"]
        [::std::mem::offset_of!(MYSQL_STMT, param_count) - 96usize];
    ["Offset of field: MYSQL_STMT::field_count"]
        [::std::mem::offset_of!(MYSQL_STMT, field_count) - 100usize];
    ["Offset of field: MYSQL_STMT::state"][::std::mem::offset_of!(MYSQL_STMT, state) - 104usize];
    ["Offset of field: MYSQL_STMT::last_error"]
        [::std::mem::offset_of!(MYSQL_STMT, last_error) - 108usize];
    ["Offset of field: MYSQL_STMT::sqlstate"]
        [::std::mem::offset_of!(MYSQL_STMT, sqlstate) - 620usize];
    ["Offset of field: MYSQL_STMT::send_types_to_server"]
        [::std::mem::offset_of!(MYSQL_STMT, send_types_to_server) - 626usize];
    ["Offset of field: MYSQL_STMT::bind_param_done"]
        [::std::mem::offset_of!(MYSQL_STMT, bind_param_done) - 627usize];
    ["Offset of field: MYSQL_STMT::bind_result_done"]
        [::std::mem::offset_of!(MYSQL_STMT, bind_result_done) - 628usize];
    ["Offset of field: MYSQL_STMT::unbuffered_fetch_cancelled"]
        [::std::mem::offset_of!(MYSQL_STMT, unbuffered_fetch_cancelled) - 629usize];
    ["Offset of field: MYSQL_STMT::update_max_length"]
        [::std::mem::offset_of!(MYSQL_STMT, update_max_length) - 630usize];
    ["Offset of field: MYSQL_STMT::extension"]
        [::std::mem::offset_of!(MYSQL_STMT, extension) - 632usize];
};
#[repr(u32)]
#[non_exhaustive]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
