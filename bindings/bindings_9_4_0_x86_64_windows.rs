...
pub const MYSQL_SERVER_VERSION: &[u8; 6] = b"9.4.0\0";
pub const MYSQL_BASE_VERSION: &[u8; 11] = b"mysqld-9.4\0";
pub const MYSQL_SERVER_SUFFIX_DEF: &[u8; 1] = b"\0";
pub const MYSQL_VERSION_ID: u32 = 90400;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of NET"][::std::mem::size_of::<NET>() - 640usize];
    ...
    ["Offset of field: NET::length"][::std::mem::offset_of!(NET, length) - 52usize];
    ["Offset of field: NET::buf_length"][::std::mem::offset_of!(NET, buf_length) - 56usize];
    ["Offset of field: NET::where_b"][::std::mem::offset_of!(NET, where_b) - 60usize];
    ["Offset of field: NET::max_packet"][::std::mem::offset_of!(NET, max_packet) - 64usize];
    ["Offset of field: NET::max_packet_size"]
        [::std::mem::offset_of!(NET, max_packet_size) - 68usize];
    ["Offset of field: NET::pkt_nr"][::std::mem::offset_of!(NET, pkt_nr) - 72usize];
    ["Offset of field: NET::compress_pkt_nr"]
        [::std::mem::offset_of!(NET, compress_pkt_nr) - 76usize];
    ["Offset of field: NET::write_timeout"][::std::mem::offset_of!(NET, write_timeout) - 80usize];
    ["Offset of field: NET::read_timeout"][::std::mem::offset_of!(NET, read_timeout) - 84usize];
    ["Offset of field: NET::retry_count"][::std::mem::offset_of!(NET, retry_count) - 88usize];
    ["Offset of field: NET::fcntl"][::std::mem::offset_of!(NET, fcntl) - 92usize];
    ["Offset of field: NET::return_status"][::std::mem::offset_of!(NET, return_status) - 96usize];
    ["Offset of field: NET::reading_or_writing"]
        [::std::mem::offset_of!(NET, reading_or_writing) - 104usize];
    ["Offset of field: NET::save_char"][::std::mem::offset_of!(NET, save_char) - 105usize];
    ["Offset of field: NET::compress"][::std::mem::offset_of!(NET, compress) - 106usize];
    ["Offset of field: NET::last_errno"][::std::mem::offset_of!(NET, last_errno) - 108usize];
    ["Offset of field: NET::error"][::std::mem::offset_of!(NET, error) - 112usize];
    ["Offset of field: NET::last_error"][::std::mem::offset_of!(NET, last_error) - 113usize];
    ["Offset of field: NET::sqlstate"][::std::mem::offset_of!(NET, sqlstate) - 625usize];
    ["Offset of field: NET::extension"][::std::mem::offset_of!(NET, extension) - 632usize];
};
#[repr(u32)]
#[non_exhaustive]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MYSQL_PLUGIN_VIO_INFO"][::std::mem::size_of::<MYSQL_PLUGIN_VIO_INFO>() - 24usize];
    ["Alignment of MYSQL_PLUGIN_VIO_INFO"]
        [::std::mem::align_of::<MYSQL_PLUGIN_VIO_INFO>() - 8usize];
    ...
    ["Offset of field: MYSQL_PLUGIN_VIO_INFO::handle"]
        [::std::mem::offset_of!(MYSQL_PLUGIN_VIO_INFO, handle) - 16usize];
};
#[repr(u32)]
#[non_exhaustive]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MYSQL_FIELD"][::std::mem::size_of::<MYSQL_FIELD>() - 120usize];
    ...
    ["Offset of field: MYSQL_FIELD::max_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, max_length) - 60usize];
    ["Offset of field: MYSQL_FIELD::name_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, name_length) - 64usize];
    ["Offset of field: MYSQL_FIELD::org_name_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, org_name_length) - 68usize];
    ["Offset of field: MYSQL_FIELD::table_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, table_length) - 72usize];
    ["Offset of field: MYSQL_FIELD::org_table_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, org_table_length) - 76usize];
    ["Offset of field: MYSQL_FIELD::db_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, db_length) - 80usize];
    ["Offset of field: MYSQL_FIELD::catalog_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, catalog_length) - 84usize];
    ["Offset of field: MYSQL_FIELD::def_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, def_length) - 88usize];
    ["Offset of field: MYSQL_FIELD::flags"][::std::mem::offset_of!(MYSQL_FIELD, flags) - 92usize];
    ["Offset of field: MYSQL_FIELD::decimals"]
        [::std::mem::offset_of!(MYSQL_FIELD, decimals) - 96usize];
    ["Offset of field: MYSQL_FIELD::charsetnr"]
        [::std::mem::offset_of!(MYSQL_FIELD, charsetnr) - 100usize];
    ["Offset of field: MYSQL_FIELD::type_"][::std::mem::offset_of!(MYSQL_FIELD, type_) - 104usize];
    ["Offset of field: MYSQL_FIELD::extension"]
        [::std::mem::offset_of!(MYSQL_FIELD, extension) - 112usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of st_mysql_options"][::std::mem::size_of::<st_mysql_options>() - 224usize];
    ...
    ["Offset of field: st_mysql_options::compress"]
        [::std::mem::offset_of!(st_mysql_options, compress) - 156usize];
    ["Offset of field: st_mysql_options::named_pipe"]
        [::std::mem::offset_of!(st_mysql_options, named_pipe) - 157usize];
    ["Offset of field: st_mysql_options::bind_address"]
        [::std::mem::offset_of!(st_mysql_options, bind_address) - 160usize];
    ["Offset of field: st_mysql_options::report_data_truncation"]
        [::std::mem::offset_of!(st_mysql_options, report_data_truncation) - 168usize];
    ["Offset of field: st_mysql_options::local_infile_init"]
        [::std::mem::offset_of!(st_mysql_options, local_infile_init) - 176usize];
    ["Offset of field: st_mysql_options::local_infile_read"]
        [::std::mem::offset_of!(st_mysql_options, local_infile_read) - 184usize];
    ["Offset of field: st_mysql_options::local_infile_end"]
        [::std::mem::offset_of!(st_mysql_options, local_infile_end) - 192usize];
    ["Offset of field: st_mysql_options::local_infile_error"]
        [::std::mem::offset_of!(st_mysql_options, local_infile_error) - 200usize];
    ["Offset of field: st_mysql_options::local_infile_userdata"]
        [::std::mem::offset_of!(st_mysql_options, local_infile_userdata) - 208usize];
    ["Offset of field: st_mysql_options::extension"]
        [::std::mem::offset_of!(st_mysql_options, extension) - 216usize];
};
#[repr(u32)]
#[non_exhaustive]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MYSQL"][::std::mem::size_of::<MYSQL>() - 1096usize];
    ...
    ["Offset of field: MYSQL::connector_fd"]
        [::std::mem::offset_of!(MYSQL, connector_fd) - 640usize];
    ["Offset of field: MYSQL::host"][::std::mem::offset_of!(MYSQL, host) - 648usize];
    ["Offset of field: MYSQL::user"][::std::mem::offset_of!(MYSQL, user) - 656usize];
    ["Offset of field: MYSQL::passwd"][::std::mem::offset_of!(MYSQL, passwd) - 664usize];
    ["Offset of field: MYSQL::unix_socket"][::std::mem::offset_of!(MYSQL, unix_socket) - 672usize];
    ["Offset of field: MYSQL::server_version"]
        [::std::mem::offset_of!(MYSQL, server_version) - 680usize];
    ["Offset of field: MYSQL::host_info"][::std::mem::offset_of!(MYSQL, host_info) - 688usize];
    ["Offset of field: MYSQL::info"][::std::mem::offset_of!(MYSQL, info) - 696usize];
    ["Offset of field: MYSQL::db"][::std::mem::offset_of!(MYSQL, db) - 704usize];
    ["Offset of field: MYSQL::charset"][::std::mem::offset_of!(MYSQL, charset) - 712usize];
    ["Offset of field: MYSQL::fields"][::std::mem::offset_of!(MYSQL, fields) - 720usize];
    ["Offset of field: MYSQL::field_alloc"][::std::mem::offset_of!(MYSQL, field_alloc) - 728usize];
    ["Offset of field: MYSQL::affected_rows"]
        [::std::mem::offset_of!(MYSQL, affected_rows) - 736usize];
    ["Offset of field: MYSQL::insert_id"][::std::mem::offset_of!(MYSQL, insert_id) - 744usize];
    ["Offset of field: MYSQL::extra_info"][::std::mem::offset_of!(MYSQL, extra_info) - 752usize];
    ["Offset of field: MYSQL::thread_id"][::std::mem::offset_of!(MYSQL, thread_id) - 760usize];
    ["Offset of field: MYSQL::packet_length"]
        [::std::mem::offset_of!(MYSQL, packet_length) - 764usize];
    ["Offset of field: MYSQL::port"][::std::mem::offset_of!(MYSQL, port) - 768usize];
    ["Offset of field: MYSQL::client_flag"][::std::mem::offset_of!(MYSQL, client_flag) - 772usize];
    ["Offset of field: MYSQL::server_capabilities"]
        [::std::mem::offset_of!(MYSQL, server_capabilities) - 776usize];
    ["Offset of field: MYSQL::protocol_version"]
        [::std::mem::offset_of!(MYSQL, protocol_version) - 780usize];
    ["Offset of field: MYSQL::field_count"][::std::mem::offset_of!(MYSQL, field_count) - 784usize];
    ["Offset of field: MYSQL::server_status"]
        [::std::mem::offset_of!(MYSQL, server_status) - 788usize];
    ["Offset of field: MYSQL::server_language"]
        [::std::mem::offset_of!(MYSQL, server_language) - 792usize];
    ["Offset of field: MYSQL::warning_count"]
        [::std::mem::offset_of!(MYSQL, warning_count) - 796usize];
    ["Offset of field: MYSQL::options"][::std::mem::offset_of!(MYSQL, options) - 800usize];
    ["Offset of field: MYSQL::status"][::std::mem::offset_of!(MYSQL, status) - 1024usize];
    ["Offset of field: MYSQL::resultset_metadata"]
        [::std::mem::offset_of!(MYSQL, resultset_metadata) - 1028usize];
    ["Offset of field: MYSQL::free_me"][::std::mem::offset_of!(MYSQL, free_me) - 1032usize];
    ["Offset of field: MYSQL::reconnect"][::std::mem::offset_of!(MYSQL, reconnect) - 1033usize];
    ["Offset of field: MYSQL::scramble"][::std::mem::offset_of!(MYSQL, scramble) - 1034usize];
    ["Offset of field: MYSQL::stmts"][::std::mem::offset_of!(MYSQL, stmts) - 1056usize];
    ["Offset of field: MYSQL::methods"][::std::mem::offset_of!(MYSQL, methods) - 1064usize];
    ["Offset of field: MYSQL::thd"][::std::mem::offset_of!(MYSQL, thd) - 1072usize];
    ["Offset of field: MYSQL::unbuffered_fetch_owner"]
        [::std::mem::offset_of!(MYSQL, unbuffered_fetch_owner) - 1080usize];
    ["Offset of field: MYSQL::extension"][::std::mem::offset_of!(MYSQL, extension) - 1088usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MYSQL_BIND"][::std::mem::size_of::<MYSQL_BIND>() - 104usize];
    ...
    ["Offset of field: MYSQL_BIND::offset"][::std::mem::offset_of!(MYSQL_BIND, offset) - 68usize];
    ["Offset of field: MYSQL_BIND::length_value"]
        [::std::mem::offset_of!(MYSQL_BIND, length_value) - 72usize];
    ["Offset of field: MYSQL_BIND::param_number"]
        [::std::mem::offset_of!(MYSQL_BIND, param_number) - 76usize];
    ["Offset of field: MYSQL_BIND::pack_length"]
        [::std::mem::offset_of!(MYSQL_BIND, pack_length) - 80usize];
    ["Offset of field: MYSQL_BIND::buffer_type"]
        [::std::mem::offset_of!(MYSQL_BIND, buffer_type) - 84usize];
    ["Offset of field: MYSQL_BIND::error_value"]
        [::std::mem::offset_of!(MYSQL_BIND, error_value) - 88usize];
    ["Offset of field: MYSQL_BIND::is_unsigned"]
        [::std::mem::offset_of!(MYSQL_BIND, is_unsigned) - 89usize];
    ["Offset of field: MYSQL_BIND::long_data_used"]
        [::std::mem::offset_of!(MYSQL_BIND, long_data_used) - 90usize];
    ["Offset of field: MYSQL_BIND::is_null_value"]
        [::std::mem::offset_of!(MYSQL_BIND, is_null_value) - 91usize];
    ["Offset of field: MYSQL_BIND::extension"]
        [::std::mem::offset_of!(MYSQL_BIND, extension) - 96usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MYSQL_STMT"][::std::mem::size_of::<MYSQL_STMT>() - 696usize];
    ...
    ["Offset of field: MYSQL_STMT::flags"][::std::mem::offset_of!(MYSQL_STMT, flags) - 132usize];
    ["Offset of field: MYSQL_STMT::prefetch_rows"]
        [::std::mem::offset_of!(MYSQL_STMT, prefetch_rows) - 136usize];
    ["Offset of field: MYSQL_STMT::server_status"]
        [::std::mem::offset_of!(MYSQL_STMT, server_status) - 140usize];
    ["Offset of field: MYSQL_STMT::last_errno"]
        [::std::mem::offset_of!(MYSQL_STMT, last_errno) - 144usize];
    ["Offset of field: MYSQL_STMT::param_count"]
        [::std::mem::offset_of!(MYSQL_STMT, param_count) - 148usize];
    ["Offset of field: MYSQL_STMT::field_count"]
        [::std::mem::offset_of!(MYSQL_STMT, field_count) - 152usize];
    ["Offset of field: MYSQL_STMT::state"][::std::mem::offset_of!(MYSQL_STMT, state) - 156usize];
    ["Offset of field: MYSQL_STMT::last_error"]
        [::std::mem::offset_of!(MYSQL_STMT, last_error) - 160usize];
    ["Offset of field: MYSQL_STMT::sqlstate"]
        [::std::mem::offset_of!(MYSQL_STMT, sqlstate) - 672usize];
    ["Offset of field: MYSQL_STMT::send_types_to_server"]
        [::std::mem::offset_of!(MYSQL_STMT, send_types_to_server) - 678usize];
    ["Offset of field: MYSQL_STMT::bind_param_done"]
        [::std::mem::offset_of!(MYSQL_STMT, bind_param_done) - 679usize];
    ["Offset of field: MYSQL_STMT::bind_result_done"]
        [::std::mem::offset_of!(MYSQL_STMT, bind_result_done) - 680usize];
    ["Offset of field: MYSQL_STMT::unbuffered_fetch_cancelled"]
        [::std::mem::offset_of!(MYSQL_STMT, unbuffered_fetch_cancelled) - 681usize];
    ["Offset of field: MYSQL_STMT::update_max_length"]
        [::std::mem::offset_of!(MYSQL_STMT, update_max_length) - 682usize];
    ["Offset of field: MYSQL_STMT::extension"]
        [::std::mem::offset_of!(MYSQL_STMT, extension) - 688usize];
};
#[repr(u32)]
#[non_exhaustive]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
