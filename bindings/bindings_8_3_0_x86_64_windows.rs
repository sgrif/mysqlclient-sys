...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of MYSQL_FIELD"][::std::mem::size_of::<MYSQL_FIELD>() - 104usize];
    ...
    ["Offset of field: MYSQL_FIELD::length"][::std::mem::offset_of!(MYSQL_FIELD, length) - 48usize];
    ["Offset of field: MYSQL_FIELD::max_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, max_length) - 52usize];
    ["Offset of field: MYSQL_FIELD::name_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, name_length) - 56usize];
    ["Offset of field: MYSQL_FIELD::org_name_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, org_name_length) - 60usize];
    ["Offset of field: MYSQL_FIELD::table_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, table_length) - 64usize];
    ["Offset of field: MYSQL_FIELD::org_table_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, org_table_length) - 68usize];
    ["Offset of field: MYSQL_FIELD::db_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, db_length) - 72usize];
    ["Offset of field: MYSQL_FIELD::catalog_length"]
        [::std::mem::offset_of!(MYSQL_FIELD, catalog_length) - 76usize];
    ["Offset of field: MYSQL_FIELD::flags"][::std::mem::offset_of!(MYSQL_FIELD, flags) - 80usize];
    ["Offset of field: MYSQL_FIELD::decimals"]
        [::std::mem::offset_of!(MYSQL_FIELD, decimals) - 84usize];
    ["Offset of field: MYSQL_FIELD::charsetnr"]
        [::std::mem::offset_of!(MYSQL_FIELD, charsetnr) - 88usize];
    ["Offset of field: MYSQL_FIELD::type_"][::std::mem::offset_of!(MYSQL_FIELD, type_) - 92usize];
    ["Offset of field: MYSQL_FIELD::extension"]
        [::std::mem::offset_of!(MYSQL_FIELD, extension) - 96usize];
};
